    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("suffix")) {
            ...
            if (args[0].equals("set")) {
                ...
                if (GenesisSMP.getUtils().getLength(prettySuffix) > config.getInt("suffixes.max-suffix-length") && !player.hasPermission("genesisprefix.bypass.length")) {
                ...
                if (GenesisSMP.getUtils().getLength(prettySuffix) < config.getInt("suffixes.min-suffix-length") && !player.hasPermission("genesisprefix.bypass.length")) {
            ...
            if (args[0].equals("confirm")) {
                ...
                if (GenesisSMP.getPlugin().waitingSuffix.get(player).equals("_remove")) {
                    ...
                    GenesisSMP.getUtils().addLogEntry(sender.getName() + " removed their suffix.");
                }
                else {
                    /*Predicate<Node> removeSuffix = NodeType.SUFFIX.predicate(n -> n.getPriority() == 1);
                    updatePlayer.data().clear(removeSuffix);
                    ...
                    GenesisSMP.getUtils().addLogEntry(sender.getName() + " changed their suffix.");
                }
